  ...
  return (
    <div style={{ minHeight: "100vh", background: "#2B2E4A" }}>
      ...
      <header style={{ padding: "16px 32px", borderBottom: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <a href="https://supered.io" target="_blank" style={{ color: "rgba(255,255,255,0.5)", fontSize: "13px", textDecoration: "none" }}>
          What is Supered? →
        </a>
      </header>
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        {step === -1 && (
          <div style={{ textAlign: "center" }}>
            <h1 style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: 900, lineHeight: 1.1, marginBottom: "16px" }}>
              What does your AI agent look like<br />
            ...
            <div style={{ maxWidth: "580px", margin: "0 auto" }}>
              <div style={{ display: "flex", gap: "8px", marginBottom: "16px" }}>
                ...
                <button
                  ...
                  style={{
                    padding: "14px 24px", background: "#E5097F",
              ...
              <div style={{ display: "flex", gap: "8px", justifyContent: "center", flexWrap: "wrap" }}>
                ...
                {DEMOS.map(d => (
                  <button key={d} onClick={() => handleDemo(d)} style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxWidth: "320px", margin: "0 auto", textAlign: "left" }}>
              {STEPS.map((s, i) => (
                <div key={i} style={{
                  ...
                  color: i < step ? "white" : i === step - 1 ? "#FEBD3B" : "rgba(255,255,255,0.3)",
          ...
          <div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "32px", marginBottom: "32px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
                <img
                  ...
                  alt="Generated swag"
                  style={{ width: "100%", borderRadius: "16px", boxShadow: "0 0 40px rgba(229,9,127,0.3)" }}
                />
                
                  href={result.image_url}
                  download="supered-swag.png"
                  target="_blank"
                  style={{
              ...
              <div>
                <div style={{
                  ...
                  padding: "4px 12px", background: "rgba(254,189,59,0.15)",
            ...
            <div style={{ textAlign: "center", paddingTop: "24px", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
              <button onClick={handleReset} style={{
                background: "none", border: "none", color: "#E5097F",
